...
class Maze:
    ...
    def __init__(self, grid_size_x, grid_size_y, screen_size, Prinses,dragon):
    ...
    def move_Princess(self, keys):
        ...
        princessloc = self.grid[-1][-1]
        princessx = GridElement.get_position_x()
        princessy = GridElement.get_position_y()
        if(keys == 'k'):
            if(princessloc.Check_if_waypossible(self, 0) == True):
                princessloc[1] += 1
